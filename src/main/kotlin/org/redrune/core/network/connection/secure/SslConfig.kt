package org.redrune.core.network.connection.secure
...
class SslConfig private constructor(
    ...
    companion object {
        ...
        operator fun invoke(
            ...
            val certificationFile = fileOrNull(certificationFileLocation) ?: return null
            val keyFile = fileOrNull(keyFileLocation) ?: return null
            val trustCertificationFile = fileOrNull(trustCertificationFileLocation) ?: return null
